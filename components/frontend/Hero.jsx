      ...
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="relative">
          <div className="lg:w-2/3">
            <h1 className="mt-6 text-2xl font-normal text-white sm:mt-10 sm:text-5xl lg:text-2xl xl:text-6xl">
            ...
            <p className="max-w-lg mt-4 text-xl font-normal text-gray-400 sm:mt-8">
              Get your music distributed globally to iTunes, Deezer, Spotify,
              Tik Tok, Youtube, Instagram, AppleMusic and more than 250 digital
              stores and streaming services.
            </p>
            <div className="relative inline-flex items-center justify-center mt-8 sm:mt-12 group">
              <div className="absolute transition-all duration-200  -inset-px bg-gradient-to-r from-cyan-500 to-purple-500 shadow-lg shadow-cyan-500/50"></div>
              <div
                title=""
                className="relative inline-flex items-center justify-center px-8 py-3 text-base font-normal text-white bg-black border border-transparent rounded-full"
              
              >
                GET FUNDING FROM $1000 UP TO $2 MILLION
              </div>
            </div>
            <div>
              <div className="inline-flex items-center pt-6 mt-8 border-t border-gray-800 sm:pt-10 sm:mt-14">
                ...
                <span className="ml-2 text-base font-normal text-white">
                  42 new artists were added last week
                </span>
              </div>
            </div>
          </div>
